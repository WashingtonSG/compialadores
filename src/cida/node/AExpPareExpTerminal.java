...
public final class AExpPareExpTerminal extends PExpTerminal
{
    private TParEsq _parEsq_;
    private PExp _exp_;
    private TParDir _parDir_;

    public AExpPareExpTerminal()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpPareExpTerminal(
    ...
    {
        ((Analysis) sw).caseAExpPareExpTerminal(this);
    }
