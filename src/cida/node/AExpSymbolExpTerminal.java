...
public final class AExpSymbolExpTerminal extends PExpTerminal
{
    private TSymbol _symbol_;

    public AExpSymbolExpTerminal()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpSymbolExpTerminal(
    ...
    {
        ((Analysis) sw).caseAExpSymbolExpTerminal(this);
    }
