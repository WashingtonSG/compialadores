...
public final class AExpMenosExpTerminal extends PExpTerminal
{
    private TMenos _menos_;
    private PExp _exp_;

    public AExpMenosExpTerminal()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpMenosExpTerminal(
    ...
    {
        ((Analysis) sw).caseAExpMenosExpTerminal(this);
    }
