...
public final class AExpStringExpTerminal extends PExpTerminal
{
    private TVetorSymbol _vetorSymbol_;

    public AExpStringExpTerminal()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpStringExpTerminal(
    ...
    {
        ((Analysis) sw).caseAExpStringExpTerminal(this);
    }
